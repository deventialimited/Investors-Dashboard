        ...
        <FieldSection>
          ...
          <Fields>
            <Dropdown>
              ...
              {isActive && (
                <DropdownContent>
                  <DropdownItem onClick={() => handleCountrySelect("USA")}>USA</DropdownItem>
                  <DropdownItem onClick={() => handleCountrySelect("UK")}>UK</DropdownItem>
                  <DropdownItem onClick={() => handleCountrySelect("Canada")}>Canada</DropdownItem>
                  <DropdownItem onClick={() => handleCountrySelect("Australia")}>Australia</DropdownItem>
                  <DropdownItem onClick={() => handleCountrySelect("Germany")}>Germany</DropdownItem>
                </DropdownContent>
              )}
            </Dropdown>
          </Fields>
